...
`.pdf` ファイルをプレビューするには、[vscode-pdf](https://marketplace.visualstudio.com/items?itemName=tomoki1207.pdf) などの拡張機能が別途必要です。
...
`yamafiler.copy` (`Y`) - 複製するためにマーク (コピー) します。フォルダーのマージもできます。
